      ...
      <div className="space-y-2">
        ...
        <input
          ...
          className={cn(
            ...
            "disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-600 disabled:border-gray-200",
            "dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:placeholder:text-gray-400 dark:focus:ring-blue-500",
            "dark:disabled:bg-gray-800/50 dark:disabled:border-gray-700 dark:disabled:text-gray-400",
