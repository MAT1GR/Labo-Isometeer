    ...
    <Popover as="div" className="relative w-full">
      {({ open, close }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute z-50 mt-1 w-full rounded-md bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden">
              <div className="p-2">
                <Input
                  type="text"
