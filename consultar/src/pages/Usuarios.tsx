...
const Usuarios: React.FC = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      setFormError('Error al cargar la lista de usuarios.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <Card>
            <h2 className="text-xl font-semibold flex items-center gap-2 mb-4"><Users /> Lista de Usuarios</h2>
        ...
        <div>
          <Card>
            <h2 className="text-xl font-semibold flex items-center gap-2 mb-4"><PlusCircle /> Crear Nuevo Usuario</h2>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                <select {...register('role')} className="w-full rounded-md border border-gray-300 px-3 py-2 mt-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
              ...
              <Button type="submit" disabled={isSubmitting} className="w-full">{isSubmitting ? 'Creando...' : 'Crear Usuario'}</Button>
            </form>
          </Card>
        </div>
      </div>
